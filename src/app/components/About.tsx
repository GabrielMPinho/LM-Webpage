    ...
    >
      <div className="relative z-10 mx-auto w-full max-w-none px-5 lg:px-12 xl:px-16 2xl:px-20">
        <div className="grid gap-7 lg:grid-cols-[minmax(0,1.05fr)_minmax(360px,0.95fr)] lg:items-start xl:gap-14">
          ...
          >
            <div className="relative -translate-y-1 overflow-hidden rounded-[2rem] border border-[#3565AD]/12 bg-white/55 p-2.5 shadow-[0_30px_80px_rgba(12,32,65,0.16)] backdrop-blur-sm lg:h-[min(80vh,50rem)] lg:-translate-y-8 lg:p-3">
              <div className="relative min-h-[18rem] overflow-hidden rounded-[1.6rem] sm:min-h-[24rem] lg:h-[min(77vh,40rem)] lg:min-h-0">
                <img
                ...
                <div className="absolute left-4 top-4 rounded-full border border-white/30 bg-[#0C2041]/55 px-3 py-1.5 text-[10px] font-medium uppercase tracking-[0.24em] text-white backdrop-blur-md md:left-5 md:top-5 md:px-4 md:py-2 md:text-xs">
                  Desde 1981
                </div>
                ...
                <motion.div
                  ...
                  className="absolute bottom-4 left-4 right-4 rounded-2xl border border-white/35 bg-white/88 p-4 shadow-2xl backdrop-blur-md md:bottom-5 md:left-5 md:right-5 md:p-5"
                >
                  <div className="flex items-center gap-3 md:gap-4">
                    <div className="flex h-[3.25rem] w-[3.25rem] items-center justify-center rounded-2xl bg-gradient-to-br from-[#3565AD] to-[#326BB4] text-xl font-bold text-white md:h-16 md:w-16 md:text-2xl">
                      45+
                    </div>

                    <div>
                      <p className="text-xs font-semibold uppercase tracking-[0.22em] text-[#3565AD] md:text-sm">
                        Experiência
                      </p>
                      <p className="mt-1 text-lg font-bold leading-tight text-[#0C2041] md:text-2xl">
