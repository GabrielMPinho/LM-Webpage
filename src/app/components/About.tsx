...
const features = [
  {
    ...
    description:
      'Catálogo completo com peças, acessórios, equipamentos e pneumáticos das melhores marcas.',
  },
  {
    icon: Globe,
        ...
        <div className="grid gap-7 lg:grid-cols-[minmax(0,1.05fr)_minmax(360px,0.95fr)] lg:items-start xl:gap-14">
          ...
          >
            ...
            <p className="mt-5 max-w-xl text-[15px] leading-relaxed text-slate-600 md:text-lg">
              Somos uma distribuidora de partes, peças, acessórios e pneumáticos para motos
